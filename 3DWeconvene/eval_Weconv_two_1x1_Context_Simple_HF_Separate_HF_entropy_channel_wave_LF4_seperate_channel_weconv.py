...
from models import TCM_Weconv_Two_1x1_Context_Simple_HF_Separate_HF_add_channel_wave_entropy_LF_4_seperate_channel_weconv
...
def main(argv):
    ...
    net = TCM_Weconv_Two_1x1_Context_Simple_HF_Separate_HF_add_channel_wave_entropy_LF_4_seperate_channel_weconv(config=[2,2,2,2,2,2], head_dim=[8, 16, 32, 32, 16, 8], drop_path_rate=0.0, N=args.N, M=320)
    net = net.to(device)
    net.eval()
    count = 0
    PSNR = 0
